...
{
    public class HammerMemoyrController : MonoBehaviour
    {
        ...
        float durationMoveHammer = 1f, multiplierScaleHammer = 2f;
        //1.8
        ...
        public void MoveHammer(Vector3 transHammerTarget,Action actionCallBackDoneAnim = null)
        {
            transform.DOMove(transHammerTarget, 0);
        ...
        {
            Debug.Log("AnimHammering bắt đầu");
            DOTween.Sequence()
            ...
            .OnComplete(() =>
                    {
                        Debug.Log("Tween scale hoàn thành");
