        ...
        private void Setup()
        {
            ...
            if (movementType == MovementType.Fixed)
            {
                ...
                if (useAutomaticLayout)
                {
                    ...
                    Content.pivot = new Vector2(movementAxis == MovementAxis.Horizontal ? 0.15f : 0.5f, movementAxis == MovementAxis.Vertical ? 0f : 0.5f);
                    ...
                    Content.sizeDelta = new Vector2(contentWidth + 1200, contentHeight);
                }
